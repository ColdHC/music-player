...
SECRET_KEY = 'django-insecure-_k*g$@l+40%2w7#-8xx%tz8u3&w3c16xaf*@fe&8bjic)jdb+d'
...
INSTALLED_APPS = [
    ...
    'Musics',  # Add the Musics app to the list of installed apps
      # Add the Pillow app to the list of installed apps
]
